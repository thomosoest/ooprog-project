...
{																	// Leser inn all data til ett arrangement
	char buff[STRLEN];
	int nr = 0;
...
void Arrangement::display() {		//Arrangement sin display funksjon
...
void Arrangement::skrivFil() {		//Arrangement skriv til fil

}


bool Arrangement::riktigSted(char* nvn) {		// Arrangement sin sted - display, sjekker om riktig sted
